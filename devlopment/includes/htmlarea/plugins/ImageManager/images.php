...
echo '<a href="javascript:;" title="View" onclick=popup("'.$manager->getBaseURL().rawurlencode(substr($file['relative'], 1)).'","ImgPreview","width='.($file['image'][0]+20).',height='.($file['image'][1]+20).'")><img src="img/edit_active.gif" height="15" width="15" alt="View"/></a>';  
