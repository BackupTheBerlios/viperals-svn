...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		smiles: [ "Insert an Emoticon", "ed_smile.gif", false, function(e) {e.execCommand("smiles");} ]
	};
...
// SMILESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
HTMLArea.prototype._smiles = function() {
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;
	this._popupDialog("insert_smiles.php", function(url) {
		//alert(url);
		if(!url) {
			return false;
		}
...
HTMLArea.prototype.getHTML = function() {
	switch (this._editMode) {
	    case "wysiwyg"  :
		if (!this.config.fullPage) {
			return HTMLArea.getHTML(this._doc.body, false, this).replace(/\n/,"");
		} else
