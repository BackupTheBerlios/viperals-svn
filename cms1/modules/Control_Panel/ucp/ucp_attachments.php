...
class ucp_attachments extends module
{
	function ucp_attachments($id, $mode)
	{
		...
		$_CLASS['core_template']->assign(array( 
			...
			'L_TITLE'				=> $_CLASS['core_user']->lang['UCP_ATTACHMENTS'],
			'L_FILENAME'			=> $_CLASS['core_user']->lang['FILENAME'],
			'L_POST_TIME'			=> $_CLASS['core_user']->lang['POST_TIME'],
			'L_FILESIZE'			=> $_CLASS['core_user']->lang['FILESIZE'],
			'L_DOWNLOADS'			=> $_CLASS['core_user']->lang['DOWNLOADS'],
			...
			'L_SORT'				=> $_CLASS['core_user']->lang['SORT'],
