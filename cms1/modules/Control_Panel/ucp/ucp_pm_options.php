...
function message_options($id, $mode, $global_privmsgs_rules, $global_rule_conditions)
{
	...
	$_CLASS['core_template']->assign(array(
		...
		'L_IF'						=> $_CLASS['core_user']->lang['IF'],
		'L_NEXT'					=> $_CLASS['core_user']->lang['NEXT'],
		'L_PREVIOUS'				=> $_CLASS['core_user']->lang['PREVIOUS'],
		'L_ADD_RULE'				=> $_CLASS['core_user']->lang['ADD_RULE'],
		'L_DEFINED_RULES'			=> $_CLASS['core_user']->lang['DEFINED_RULES'],
		'L_DELETE_RULE'				=> $_CLASS['core_user']->lang['DELETE_RULE'],
		'L_NO_RULES_DEFINED'		=> $_CLASS['core_user']->lang['NO_RULES_DEFINED'],
		'L_ADD_FOLDER'				=> $_CLASS['core_user']->lang['ADD_FOLDER'],
		'L_MAX_FOLDER_REACHED'		=> $_CLASS['core_user']->lang['MAX_FOLDER_REACHED'],
		'L_ADD_FOLDER'				=> $_CLASS['core_user']->lang['ADD_FOLDER'],
		'L_ADD'						=> $_CLASS['core_user']->lang['ADD'],
		'L_REMOVE_FOLDER'			=> $_CLASS['core_user']->lang['REMOVE_FOLDER'],
		'L_AND'						=> $_CLASS['core_user']->lang['AND'],
		'L_REMOVE'					=> $_CLASS['core_user']->lang['REMOVE'],
		'L_FOLDER_OPTIONS'			=> $_CLASS['core_user']->lang['FOLDER_OPTIONS'],
		'L_IF_FOLDER_FULL'			=> $_CLASS['core_user']->lang['IF_FOLDER_FULL'],
		'L_DELETE_OLDEST_MESSAGES'	=> $_CLASS['core_user']->lang['DELETE_OLDEST_MESSAGES'],
		'L_MOVE_TO_FOLDER'			=> $_CLASS['core_user']->lang['MOVE_TO_FOLDER'],
		'L_HOLD_NEW_MESSAGES'		=> $_CLASS['core_user']->lang['HOLD_NEW_MESSAGES'],
		'L_DEFAULT_ACTION'			=> $_CLASS['core_user']->lang['DEFAULT_ACTION'],
		'L_DEFAULT_ACTION_EXPLAIN'	=> $_CLASS['core_user']->lang['DEFAULT_ACTION_EXPLAIN'],
		'L_CHANGE'					=> $_CLASS['core_user']->lang['CHANGE'],
		'L_RENAME_FOLDER'			=> $_CLASS['core_user']->lang['RENAME_FOLDER'],
		'L_NEW_FOLDER_NAME'			=> $_CLASS['core_user']->lang['NEW_FOLDER_NAME'],
		'L_MOVE_DELETED_MESSAGES_TO'=> $_CLASS['core_user']->lang['MOVE_DELETED_MESSAGES_TO'],
		'L_DELETE_MESSAGES_IN_FOLDER'=> $_CLASS['core_user']->lang['DELETE_MESSAGES_IN_FOLDER'],
		'L_RENAME'					=> $_CLASS['core_user']->lang['RENAME'],
