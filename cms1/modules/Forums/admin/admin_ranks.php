...
<form method="post" action="<?php echo adminlink('forums&amp;file=admin_ranks&amp;id=$rank_id'); ?>"><table class="bg" cellspacing="1" cellpadding="4" border="0" align="center">
	<tr>
...
<form method="post" action="<?php echo adminlink('forums&amp;file=admin_ranks'); ?>"><table class="bg" cellspacing="1" cellpadding="4" border="0" align="center">
	<tr>
...
?></td>
		...
		<td class="<?php echo $row_class; ?>" align="center">&nbsp;<a href="<?php echo adminlink('forums&amp;file=admin_ranks&amp;mode=edit&amp;id=' . $row['rank_id']); ?>"><?php echo $_CLASS['core_user']->lang['EDIT']; ?></a> | <a href="<?php echo adminlink('forums&amp;file=admin_ranks&amp;mode=delete&amp;id=' . $row['rank_id']); ?>"><?php echo $_CLASS['core_user']->lang['DELETE']; ?></a>&nbsp;</td>
	</tr>
<?php
