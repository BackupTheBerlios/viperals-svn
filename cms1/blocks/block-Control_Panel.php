...
if (!isset($_CLASS['core_template']->_tpl_vars['ucp_section']))
{
	return;
}

if ($_CLASS['core_template']->_tpl_vars['S_SHOW_PM_BOX'] && $_CLASS['core_template']->_tpl_vars['S_POST_ACTION']) :

$this->content .= '<form action="'.$_CLASS['core_template']->_tpl_vars['S_POST_ACTION'].'" method="post" name="post1"'.$_CLASS['core_template']->_tpl_vars['S_FORM_ENCTYPE'].'>
	<table class="tablebg" width="100%" cellspacing="1">
		<tr>
			<th>'.$_CLASS['core_template']->_tpl_vars['L_PM_TO'].'</th>
		</tr>
		<tr>
			<td class="row1"><b class="genmed">'. $_CLASS['core_template']->_tpl_vars['L_USERNAME'] .'
:</b></td>
		</tr>
		<tr>
			<td class="row2"><input class="post" type="text" name="username" size="20" maxlength="40" value="" />&nbsp;<input class="post" type="submit" name="add_to" value="'.$_CLASS['core_template']->_tpl_vars['L_ADD'].'" /></td>
		</tr>';


if ($_CLASS['core_template']->_tpl_vars['S_ALLOW_MASS_PM']) :

$this->content .= '<tr>
			<td class="row1"><b class="genmed"><'. $_CLASS['core_template']->_tpl_vars['L_USERNAMES'].':</b></td>
		</tr>
		<tr>
			<td class="row2"><textarea name="username_list" rows="5" cols="20"></textarea><br />
				<ul class="phpbbnav" style="margin: 0px; padding: 0px; list-style-type: none; line-height: 175%;">
					<li>&#187; <a href="'. $_CLASS['core_template']->_tpl_vars['U_SEARCH_USER'] .'
" onclick="window.open(\''. $_CLASS['core_template']->_tpl_vars['U_SEARCH_USER'] .'\', \'_phpbbsearch\', \'HEIGHT=500,resizable=yes,scrollbars=yes,WIDTH=740\');return false"> '. $_CLASS['core_template']->_tpl_vars['L_FIND_USERNAME'].'
</a></li>
				</ul>
			</td>
		</tr>';
...
if ($_CLASS['core_template']->_tpl_vars['S_GROUP_OPTIONS']):
		
$this->content .= '<tr>
			<td class="row1"><b class="genmed">'. $_CLASS['core_template']->_tpl_vars['L_USERGROUPS'].'
:</b></td>
		</tr>
		<tr>
			<td class="row2"><select name="group_list[]" multiple="true" size="5" style="width:150px">'.$_CLASS['core_template']->_tpl_vars['S_GROUP_OPTIONS'].'
</select></td>
		</tr>';
endif;
...
if ($_CLASS['core_template']->_tpl_vars['S_ALLOW_MASS_PM']):
$this->content .= '<tr>
			<td class="row1"><div style="float:left">&nbsp;<input class="post" type="submit" name="add_bcc" value="'.$_CLASS['core_template']->_tpl_vars['L_ADD_BCC'].'
" />&nbsp;</div><div style="float:right">&nbsp;<input class="post" type="submit" name="add_to" value="'.$_CLASS['core_template']->_tpl_vars['L_ADD_TO'].'
" />&nbsp;</div></td>
		</tr>';
endif;
...
unset($_CLASS['core_template']->_sections['ucp_sectionloop']);

$_CLASS['core_template']->_sections['ucp_sectionloop']['name'] = 'ucp_sectionloop';
$_CLASS['core_template']->_sections['ucp_sectionloop']['loop'] = is_array($_loop=$_CLASS['core_template']->_tpl_vars['ucp_section']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
if ($_CLASS['core_template']->_tpl_vars['ucp_section'][$_CLASS['core_template']->_sections['ucp_sectionloop']['index']]['S_SELECTED']):
$this->content .= '<td class="row1"><b class="phpbbnav">'.$_CLASS['core_template']->_tpl_vars['ucp_section'][$_CLASS['core_template']->_sections['ucp_sectionloop']['index']]['L_TITLE'].'
</b>
...
$_CLASS['core_template']->_sections['ucp_subsectionloop']['loop'] = is_array($_loop=$_CLASS['core_template']->_tpl_vars['ucp_subsection']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->content .= '<li>&#187;';
if ($_CLASS['core_template']->_tpl_vars['ucp_subsection'][$_CLASS['core_template']->_sections['ucp_subsectionloop']['index']]['S_SELECTED']):

$this->content .= ' <b>'.$_CLASS['core_template']->_tpl_vars['ucp_subsection'][$_CLASS['core_template']->_sections['ucp_subsectionloop']['index']]['L_TITLE'].'
</b>';

else: 

$this->content .= '<a href="'.$_CLASS['core_template']->_tpl_vars['ucp_subsection'][$_CLASS['core_template']->_sections['ucp_subsectionloop']['index']]['U_TITLE'].'"> '.$_CLASS['core_template']->_tpl_vars['ucp_subsection'][$_CLASS['core_template']->_sections['ucp_subsectionloop']['index']]['L_TITLE'].'
</a>';
...
$this->content .= '<td class="row2" nowrap="nowrap" onmouseover="this.className=\'row1\'" onmouseout="this.className=\'row2\'" onclick="location.href=\''.$_CLASS['core_template']->_tpl_vars['ucp_section'][$_CLASS['core_template']->_sections['ucp_sectionloop']['index']]['U_TITLE'].'\'"><a class="phpbbnav" href="'.$_CLASS['core_template']->_tpl_vars['ucp_section'][$_CLASS['core_template']->_sections['ucp_sectionloop']['index']]['U_TITLE'].'
">'.$_CLASS['core_template']->_tpl_vars['ucp_section'][$_CLASS['core_template']->_sections['ucp_sectionloop']['index']]['L_TITLE'].'
</a>';
...
if ($_CLASS['core_template']->_tpl_vars['S_SHOW_COLOUR_LEGEND']):

$this->content .= '<table class="tablebg" width="100%" cellspacing="1" cellpadding="0">
	<tr>
		<th colspan="2">'.$_CLASS['core_template']->_tpl_vars['L_MESSAGE_COLOURS'].'
</th>
	</tr>';
...
$_CLASS['core_template']->_sections['pm_colour_infoloop']['loop'] = is_array($_loop=$_CLASS['core_template']->_tpl_vars['pm_colour_info']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
if (! $_CLASS['core_template']->_tpl_vars['pm_colour_info'][$_CLASS['core_template']->_sections['pm_colour_infoloop']['index']]['IMG']):

			$this->content .= '<td class="row1 '.$_CLASS['core_template']->_tpl_vars['pm_colour_info'][$_CLASS['core_template']->_sections['pm_colour_infoloop']['index']]['CLASS'].'
" width="5"><img src="images/spacer.gif" width="5" alt="'.$_CLASS['core_template']->_tpl_vars['pm_colour_info'][$_CLASS['core_template']->_sections['pm_colour_infoloop']['index']]['LANG'].'
" border="0" /></td>';

else:
			
	$this->content .= '<td class="row1" width="25" align="center">'. $_CLASS['core_template']->_tpl_vars['pm_colour_info'][$_CLASS['core_template']->_sections['pm_colour_infoloop']['index']]['IMG'].'
</td>';

endif;

		$this->content .= '<td class="row1"><span class="genmed">'.$_CLASS['core_template']->_tpl_vars['pm_colour_info'][$_CLASS['core_template']->_sections['pm_colour_infoloop']['index']]['LANG'].'
</span></td>
	</tr>';
...
$this->content .= '<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<th>'.$_CLASS['core_template']->_tpl_vars['L_FRIENDS'].'
</th>
	</tr>
	<tr>
		<td class="row1" align="center">
		
			<b class="genmed" style="color:green">'.$_CLASS['core_template']->_tpl_vars['L_FRIENDS_ONLINE'].'
</b>
...
$_CLASS['core_template']->_sections['friends_onlineloop']['loop'] = is_array($_loop=$_CLASS['core_template']->_tpl_vars['friends_online']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$_CLASS['core_template']->_sections['friends_onlineloop']['last']       = ($_CLASS['core_template']->_sections['friends_onlineloop']['iteration'] == $_CLASS['core_template']->_sections['friends_onlineloop']['total']);
				...
				$this->content .= '<li><a href="'.$_CLASS['core_template']->_tpl_vars['friends_online'][$_CLASS['core_template']->_sections['friends_onlineloop']['index']]['U_PROFILE'].'
">'.$_CLASS['core_template']->_tpl_vars['friends_online'][$_CLASS['core_template']->_sections['friends_onlineloop']['index']]['USERNAME'].'
</a>';

if ($_CLASS['core_template']->_tpl_vars['S_SHOW_PM_BOX']):
					$this->content .= '&nbsp;[ <input class="post" style="font-size: 90%;" type="submit" name="add_to['.$_CLASS['core_template']->_tpl_vars['friends_online'][$_CLASS['core_template']->_sections['friends_onlineloop']['index']]['USER_ID'].'
					]" value="'.$_CLASS['core_template']->_tpl_vars['L_ADD'].'" /> ]';
			...
			$this->content .= '<li>'.$_CLASS['core_template']->_tpl_vars['L_NO_FRIENDS_ONLINE'].'
</li>';
			endif;
			$this->content .= '</ul>
			...
			<b class="genmed" style="color:red">'.$_CLASS['core_template']->_tpl_vars['L_FRIENDS_OFFLINE'].'
</b>
...
$_CLASS['core_template']->_sections['friends_offlineloop']['loop'] = is_array($_loop=$_CLASS['core_template']->_tpl_vars['friends_offline']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$_CLASS['core_template']->_sections['friends_offlineloop']['last']       = ($_CLASS['core_template']->_sections['friends_offlineloop']['iteration'] == $_CLASS['core_template']->_sections['friends_offlineloop']['total']);
			...
			$this->content .= '<li><a href="'.$_CLASS['core_template']->_tpl_vars['friends_offline'][$_CLASS['core_template']->_sections['friends_offlineloop']['index']]['U_PROFILE'].'
">'.$_CLASS['core_template']->_tpl_vars['friends_offline'][$_CLASS['core_template']->_sections['friends_offlineloop']['index']]['USERNAME'].'
</a>';

if ($_CLASS['core_template']->_tpl_vars['S_SHOW_PM_BOX']):
					$this->content .= '&nbsp;[ <input class="post" style="font-size: 90%;" type="submit" name="add_to['.$_CLASS['core_template']->_tpl_vars['friends_offline'][$_CLASS['core_template']->_sections['friends_offlineloop']['index']]['USER_ID'].'
]" value="'.$_CLASS['core_template']->_tpl_vars['L_ADD'].'
" /> ]';
				endif;
			endfor; else:
			$this->content .= '<li>'.$_CLASS['core_template']->_tpl_vars['L_NO_FRIENDS_OFFLINE'].'
</li>';
			endif;
			$this->content .= '</ul>
